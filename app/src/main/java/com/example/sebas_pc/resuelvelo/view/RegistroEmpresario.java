...
public class RegistroEmpresario extends AppCompatActivity implements View.OnClickListener {
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if(task.isSuccessful()){
                            ...
                            Toast.makeText(RegistroEmpresario.this,"RegistroEmpresario Erroneo", Toast.LENGTH_LONG).show();
                        }
    ...
    private void onAuthSuccess(FirebaseUser user) {
        ...
        startActivity(new Intent(RegistroEmpresario.this, PerfilEmpresario.class));
        finish();
    }
